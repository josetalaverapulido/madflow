...
def get_data(url: str):
    """
    Extracts all ZIP (CSV) file links from the specified page and saves them in a JSON file.
    If any required element is missing, an exception is raised.
    """
    try:
    ...
    for year in years:
        ...
        for m in months:
            ...
            if month_text is None:
                # logging.warning(f"Month title not found in year {year_value}. Skipping.")
                continue
    ...
    # Always save in the directory where this script is located
